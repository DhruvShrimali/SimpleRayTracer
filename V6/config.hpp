...
constexpr int EPOCHLIMIT = 10;           // Maximum epoch runs
...
constexpr bool DOF = false;              // Enable Depth of Field (true → objects at focal distance sharp, others blurred)
...
constexpr double FOCAL_DISTANCE = 280.0; // Distance at which camera is perfectly focused (used with DOF)

//Do not change the things below this line
constexpr double TIME_MODIFIER = 451952;
