...
class colour{
    ...
    colour(short int i,short int j,short int k){
        r=i;
        g=j;
        b=k;
    }
    ...
    void mult(int i, int j, int k){
        ...
        g1=g*j;
        b1=b*k;
        r=(short int)floor(r1/255);
        g=(short int)floor(g1/255);
        b=(short int)floor(b1/255);
    }
...
void renderImagePart(int startRow, int endRow, int rayPerPixel, int neighborPerPixel, std::vector<Sphere> &spheres, colour **image, int WIDTH) {
...
int main() {
    ...
    spheres.push_back(Sphere(vect(100, 400, 180), 100, 3, 0, colour(255, 255, 255), true)); //light
    spheres.push_back(Sphere(vect(200, 400, 180), 100, 3, 0, colour(255, 255, 255), true)); //light
    ...
    spheres.push_back(Sphere(vect(200, 70, 220), 70, 0.999, 0, colour(255, 200, 255), false));
    ...
    time /= 270500; //obtained experimentally
    ...
    // std::cout<<rowsPerThread<<std::endl;
    ...
    for (int i = 0; i < numThreads; ++i) {
        ...
        threads.emplace_back([startRow, endRow, ray_per_pixel, neighbour_per_pixel, &spheres, imageData, WIDTH]() {
            renderImagePart(startRow, endRow, ray_per_pixel, neighbour_per_pixel, spheres, imageData, WIDTH);
        });
    }
