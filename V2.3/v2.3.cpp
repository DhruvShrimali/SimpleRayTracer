...
int main() {
    ...
    spheres.push_back(Sphere(vect(60, 40, 210), 35, 0.99, 0, colour(250, 255, 255), false)); // three spheres
    spheres.push_back(Sphere(vect(50, 130, 120), 45, 0.99, 0, colour(200, 200, 0), false));
    spheres.push_back(Sphere(vect(200, 70, 200), 70, 0.99, 0, colour(255, 200, 255), false));
    
    spheres.push_back(Sphere(vect(150, -5000, 120), 5000, 0.95, 1.4, colour(255, 255, 255), false)); //bottom floor
    spheres.push_back(Sphere(vect(150, 5350, 120), 5000, 0.95, 1.4, colour(255, 255, 255), false)); //ceiling
    spheres.push_back(Sphere(vect(150, 175, 5240), 5000, 0.95, 1.4, colour(200, 255, 200), false)); //front wall
    spheres.push_back(Sphere(vect(150, 175, -5021), 5000, 0.95, 1.4, colour(255, 255, 255), false)); //back wall
    spheres.push_back(Sphere(vect(5300, 175, 120), 5000, 0.95, 1.4, colour(255, 200, 200), false)); //left wall
    spheres.push_back(Sphere(vect(-5000, 175, 120), 5000, 0.95, 1.4, colour(200, 200, 255), false)); //right wall
